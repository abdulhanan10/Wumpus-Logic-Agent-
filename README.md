...
How It Works
Logic Pipeline
Agent visits cell [r,c]
TELL: percept facts added as unit clauses to KB (CNF)
TELL: biconditional rules B_{r}_{c} ⟺ (P_adj1 ∨ P_adj2 ∨ ...) added
ASK: For each unvisited adjacent cell — assume hazard, run Resolution Refutation
If contradiction (⊥) derived → cell proved safe → agent moves there
